...
foreach ($lesEleves as $unEleve) {
    ...
    <div class='col-xs-4 col-sm-3 col-md-2 col-lg-1'>
        <div class='row small'>
            ...
            <div class='col-xs-1 col-sm-2'>
                <a href="index.php?uc=action&num=supprimer&e=<?php echo $unEleve['numeleve']; ?>" class='text-secondary' title='supprimer la photo' ><span class="fas fa-user-times"></span></a>
            </div>
        ...
        $cheminImage = $DOSSIERUPLOAD . $unEleve['path'] . "/" . dec2hex($unEleve['numfichier']) . $unEleve['extension'];
    } echo $cheminImage; ?>"  width="80" > 
                </a>
            </div>
